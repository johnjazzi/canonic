...
* \[ ] create askill for claude that auto opens canonical when you have a markdown file

* \[ ] need to add in all the old stuff I built for the editor
