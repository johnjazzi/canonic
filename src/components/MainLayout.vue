    ...
    <div class="content">
      ...
      <aside class="sidebar">
        <div class="sidebar-tabs">
          ...
          <button :class="['tab', store.sidebarTab === 'peers' && 'active']" @click="store.sidebarTab = 'peers'" title="Shared with me" v-if="store.isDemoMode || store.demoPeers.length">
            <Users :size="15" />
          </button>
        </div>
...
import PeersPanel from './PeersPanel.vue'
